...
defmodule BpyMcp do
  @moduledoc """
  Blender bpy MCP - Model Context Protocol server for Blender 3D operations.

  Provides context-managed access to Blender functionality through process barriers.
  """
  ...
  @doc """
  Sets the current Blender scene context.
